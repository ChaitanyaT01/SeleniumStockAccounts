...
public class ExcelFileUtil 
{
	...
	{
		FileInputStream fis=new FileInputStream("C:\\Users\\chaitanya.t\\workspace\\Chaitanya\\TestProject\\TestInputs\\InputSheet.xlsx");
	...
	public void setData(String sheetname,int row,int column,String status) throws Throwable
	{
		...
		FileOutputStream fos=new FileOutputStream("C:\\Users\\chaitanya.t\\workspace\\Chaitanya\\TestProject\\TestOutput\\OutputSheet.xls");
		wb.write(fos);
		fos.close();
	}
